...
//   // TODO centerpoint can be thought of as a translation to a "center space"?
//   getCenterPoint(): TDim;
//   getSize(): TDim;
...
//   getRelativeScale(
//     otherHull: Hull<TNum, TDim>
//   ): TDim extends ObjV3<TNum> ? ScaleArray : ScaleArray2D;
//   getRelativeTranslation(
//     otherHull: Hull<TNum, TDim>
//   ): TDim extends ObjV3<TNum> ? TranslationArray : TranslationArray2D;

//   // TODO hulls are only isomorphic on translation & scale - encode this for 2d
//   // a rotated hull is an invalid hull, unless we add a concept of "upvec" (dont think would be useful)
//   getAffineToOtherHull(
//     otherHull: Hull<TNum, TDim>
//   ): TDim extends ObjV3<TNum> ? NonRotationMatrix : TwoDimSpaceMatrixAsArray;
